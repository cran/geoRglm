...
<<eval=F,label="Poisson Bayesian Kriging 2">>=
mcmc5 <- mcmc.control(S.scale = 0.075, thin = 100)
test5 <- pois.krige.bayes(p50, locations = t(cbind(c(2.5,3),c(-6050,-3270))), prior = prior5, mcmc.input = mcmc5, output = list(threshold = 10, quantile = c(0.05,0.99)))
@ 
<<echo=F>>=
mcmc5 <- mcmc.control(S.scale = 0.075, thin = 100)
test5 <- pois.krige.bayes(p50, locations = t(cbind(c(2.5,3),c(-6050,-3270))), prior = prior5, mcmc.input = mcmc5, output = list(threshold = 10, quantile = c(0.05,0.99)))
